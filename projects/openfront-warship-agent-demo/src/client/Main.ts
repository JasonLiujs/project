...
class Client {
  ...
  private async handleUrl() {
    ...
    if (searchParams.get("demo") === "warship-diagonal-chase") {
      this.launchWarshipDemo();
      return;
    }
      ...
      new CustomEvent("join-lobby", {
        detail: {
          ...
          gameStartInfo: {
            ...
            players: [
              {
                clientID: "demo-hunter",
                username: "Harbor Guard",
                clanTag: null,
                isLobbyCreator: true,
              },
              {
                clientID: "demo-trader",
                username: "Merchant Fleet",
                clanTag: null,
              },
            ],
            config: {
              gameMap: GameMapType.TradersDream,
              ...
              demoScenario: "warship-diagonal-chase",
            },
          },
          source: "singleplayer",
  ...
  private async handleJoinLobby(event: CustomEvent<JoinLobbyEvent>) {
    ...
    const isWarshipDemo =
      lobby.gameStartInfo?.config.demoScenario === "warship-diagonal-chase";
    // Only update URL immediately for private lobbies, not public ones
    if (lobby.source !== "public" && !isWarshipDemo) {
    ...
    this.lobbyHandle.join.then(() => {
      ...
      if (isWarshipDemo) {
        history.replaceState(null, "", "/?demo=warship-diagonal-chase");
      } else {
