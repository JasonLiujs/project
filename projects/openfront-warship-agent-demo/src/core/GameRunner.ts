...
import { WarshipDiagonalChaseDemoExecution } from "./execution/demo/WarshipDiagonalChaseDemoExecution";
...
export class GameRunner {
  ...
  init() {
    ...
    if (
      this.game.config().gameConfig().demoScenario === "warship-diagonal-chase"
    ) {
      this.game.addExecution(new WarshipDiagonalChaseDemoExecution());
    }
  }
